...
from model import EmbeddingImagenet, Unet,Unet2,Unet3
import shutil
import os
import random
...
if __name__ == '__main__':
    ...
    enc_module = EmbeddingImagenet(tt.arg.emb_size)  # extract features
    # coarse_enc_module = Coarse_EmbeddingImagenet(emb_size=tt.arg.coarse_emb_size)
    ...
    checkpoint = torch.load('./checkpoints/{}/'.format(tt.arg.exp_name) + 'model_best.pth.tar',map_location=tt.arg.device)
